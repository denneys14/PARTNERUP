...
partner_one = Partner.create(user: user_one, name: 'peter', gender: 'm', address: "Gyßlingstraße, 80805 München", duty: "walks your dog", url_photo: "https://images.unsplash.com/photo-1529831129093-0fa4866281ee?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
...
partner_four = Partner.create(user: user_four, name: 'daniel', gender: 'm', address: "Agnesstraße 1-5, 80801 München", duty: "picks up your package from the postoffice", url_photo: "https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
partner_eight = Partner.create(user: user_six, name: 'pia', gender: 'f', address: " Tengstraße 21, 80798 München", duty: "sets up your flowerbed", url_photo: "https://images.unsplash.com/photo-1536235918060-dd0b5d3d0dda?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
